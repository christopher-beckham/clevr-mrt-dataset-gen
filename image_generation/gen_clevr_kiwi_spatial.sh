...
# Generate Train set
~/.local/bin/blender/blender --background --python render_images.py -- --num_images 4 --use_gpu 1 \
--all_chars_visible --base_scene_blendfile data/base_scene_tub.blend --split train-clevr-kiwi-spatial  --multi_view \
...
# Generate Val set
~/.local/bin/blender/blender --background --python render_images.py -- --num_images 32 --use_gpu 1 --multi_view \
--all_chars_visible --base_scene_blendfile data/base_scene_tub.blend --enforce_obj_visibility --split val-clevr-kiwi-spatial\
...
## Generate test set
~/.local/bin/blender/blender --background --python render_images.py -- --num_images 32 --use_gpu 1 --multi_view \
--all_chars_visible --base_scene_blendfile data/base_scene_tub.blend --enforce_obj_visibility --split test-clevr-kiwi-spatial\
